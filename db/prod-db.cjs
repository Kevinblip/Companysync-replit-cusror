...
async function initDatabase() {
  ...
  try {
    const REAL_TASKS = [
      { id: 'task_import_1773686765738_43', title: 'Roof Install (Retail) - Francesca Laing', description: 'Residential roof installation', assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"}]', related_to: 'Francesca Laing', column: 'job_completed', created_by: 'stonekevin866@gmail.com', created_at: '2025-10-28' },
      { id: 'task_import_1773686765735_42', title: 'Roof Install (Insurance) - Levaties Sands', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"},{"email":"raffy.vpa28@gmail.com"},{"email":"yicnteam@gmail.com"}]', related_to: null, column: 'paid_in_full_send_warranty', created_by: 'stonekevin866@gmail.com', created_at: '2025-10-28' },
      { id: 'task_import_1773686765733_41', title: 'Roof Repair (Insurance) Gina Hill', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"},{"email":"raffy.vpa28@gmail.com"},{"email":"yicnteam@gmail.com"}]', related_to: null, column: 'complete', created_by: 'stonekevin866@gmail.com', created_at: '2025-10-28' },
      { id: 'task_import_1773686765730_40', title: 'Roof & Siding Install - (Insurance) Diane Stone', description: null, assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"}]', related_to: 'Diane Stone', column: 'in_progress', created_by: 'stonekevin866@gmail.com', created_at: '2025-10-28' },
      { id: 'task_import_1773686765727_39', title: 'Roof Install - Sedgwick - Laura Brown', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"},{"email":"raffy.vpa28@gmail.com"},{"email":"yicnteam@gmail.com"}]', related_to: null, column: 'initial_payment_received', created_by: 'stonekevin866@gmail.com', created_at: '2025-10-28' },
      { id: 'task_import_1773686765724_38', title: 'Roof Install (Insurance)', description: null, assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"},{"email":"raffy.vpa28@gmail.com"},{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Anthony President', column: 'customer_lost', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2025-11-20' },
      { id: 'task_import_1773686765721_37', title: 'Roof Install (Insurance) Brenda K. Bell', description: null, assigned_to: null, assignees: '[]', related_to: 'Brenda Kathy Bell', column: 'complete', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2025-11-21' },
      { id: 'task_import_1773686765719_36', title: 'Susan Rife Roof Install', description: null, assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"}]', related_to: 'Susan Rife', column: 'work_order_schedule_crew', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-01-02' },
      { id: 'task_import_1773686765716_35', title: 'Ilka Hall - Siding Work', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"},{"email":"yicnteam@gmail.com"}]', related_to: 'Ilka Hall', column: 'job_completed', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-01-15' },
      { id: 'task_import_1773686765713_34', title: 'Insurance - Roof Install (Linda Whitehead)', description: null, assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"}]', related_to: 'Linda Whitehead', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-01-16' },
      { id: 'task_import_1773686765710_33', title: 'Reminder for Kevin - Call James Garrison', description: 'James Garrison\n(234) 442-2353\n\nNotes:\nsold roofs for 10+ years\nmanager at Xtreme Roofing and Construction in Florida', assigned_to: null, assignees: '[]', related_to: null, column: 'customer_lost', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-01-19' },
      { id: 'task_import_1773686765707_32', title: 'Roof Install (Raffy Test)', description: null, assigned_to: 'raffy.vpa28@gmail.com', assignees: '[{"email":"raffy.vpa28@gmail.com"}]', related_to: 'Test Raffy 1/19', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-01-20' },
      { id: 'task_import_1773686765705_31', title: 'Roof Leak - Rebecca Heasley', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Rebecca Heasley', column: 'complete', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-02-02' },
      { id: 'task_import_1773686765702_30', title: 'Roof Install - Rubin Maultrie - Sedgwick', description: null, assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"}]', related_to: 'RUBIN MOULTRIE', column: 'customer_lost', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-02' },
      { id: 'task_import_1773686765699_29', title: 'Roof Install - Mary Pope - Sedgwick', description: null, assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"}]', related_to: 'MARY POPE', column: 'awaiting_feedback', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-02' },
      { id: 'task_import_1773686765696_28', title: 'Roof Install - James Hunt - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'James Hunt', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765694_27', title: 'Ervin Anton - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'ERVIN ANITON', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765691_26', title: 'Larry Reynolds - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'LARRY REYNOLDS', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765688_25', title: 'TOMMY GRANDISON - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'TOMMY GRANDISON', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765684_24', title: 'YOLANDA HARRIS - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'YOLANDA HARRIS', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765681_23', title: 'JOANN REED - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'JOANN REED', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765678_22', title: 'DENISE MOORE - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'DENISE MOORE', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765675_21', title: 'LAWANDA REDWINE - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'LAWANDA REDWINE', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765670_20', title: 'YVONNE WILLIS - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'YVONNE WILLIS', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765666_19', title: 'KAROL GLADDEN - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'KAROL GLADDEN', column: 'awaiting_payment', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-03' },
      { id: 'task_import_1773686765664_18', title: 'Christina Fox - Habitat', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Christina Fox', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-06' },
      { id: 'task_import_1773686765661_17', title: 'Roof Install (Raffy)', description: null, assigned_to: 'raffy.vpa28@gmail.com', assignees: '[{"email":"raffy.vpa28@gmail.com"}]', related_to: 'Raffy (Test)', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-09' },
      { id: 'task_import_1773686765658_16', title: 'Chimney Leak - Mike Savol', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Mike Savol', column: 'complete', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-02-11' },
      { id: 'task_import_1773686765654_15', title: 'Roof Install - Jeffrey Hurt - Sedgwick', description: null, assigned_to: 'raffy.vpa28@gmail.com', assignees: '[{"email":"raffy.vpa28@gmail.com"}]', related_to: 'JEFFREY HURT', column: 'job_completed', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-13' },
      { id: 'task_import_1773686765652_14', title: 'Roof Repair - Sam Lichtman-Mikol', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Sam Lichtman-Mikol', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-02-16' },
      { id: 'task_import_1773686765648_13', title: 'Roof Install - Sohl, Chad - Sedgwick', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Sohl, Chad', column: 'awaiting_feedback', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-17' },
      { id: 'task_import_1773686765645_12', title: 'Roof Install - Barbara Brandt - Sedgwick', description: null, assigned_to: 'yicnteam@gmail.com', assignees: '[{"email":"yicnteam@gmail.com"}]', related_to: 'BARBARA BRANDT', column: 'awaiting_feedback', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-19' },
      { id: 'task_import_1773686765642_11', title: 'Roof Install - Marcia Banks - Sedgwick', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Marcia Banks', column: 'awaiting_feedback', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-19' },
      { id: 'task_import_1773686765639_10', title: 'Roof Install - Kristina Longino - Sedwick', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'KRISTINA LONGINO', column: 'awaiting_feedback', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-20' },
      { id: 'task_import_1773686765636_9', title: 'Roof Repair', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'John', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-02-23' },
      { id: 'task_import_1773686765632_8', title: 'Roof Install - Brittany Wilson - Sedgwick', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"},{"email":"brian.yicn@gmail.com"}]', related_to: 'BRITTANY WILSON', column: 'awaiting_feedback', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-02-23' },
      { id: 'task_import_1773686765627_7', title: 'Roof Repair (Insurance) EARLINE COTTRELL', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'EARLINE COTTRELL', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-03-05' },
      { id: 'task_import_1773686765623_6', title: 'Gutter Repair', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Harvey Mitchell', column: 'not_started', created_by: 'raffy.vpa28@gmail.com', created_at: '2026-03-10' },
      { id: 'task_import_1773686765620_5', title: 'Roof Repair Retail', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Victor Ruiz', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-03-12' },
      { id: 'task_import_1773686765571_0', title: 'Roof Repair - Thomas Owens', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Thomas Owens', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-03-16' },
      { id: 'task_import_1773686765606_1', title: 'Sedgwick - Repair Martin Mc Ginty', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Martin Mc Ginty', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-03-16' },
      { id: 'task_import_1773686765609_2', title: 'Sedgwick - Repair Peter Viskocil', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Peter Viskocil', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-03-16' },
      { id: 'task_import_1773686765613_3', title: 'Sedgwick - Repair Adam Acharya', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"}]', related_to: 'Adam Acharya', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-03-16' },
      { id: 'task_import_1773686765617_4', title: 'Schedule inspection', description: null, assigned_to: 'victoriafeliciapatindol@gmail.com', assignees: '[{"email":"victoriafeliciapatindol@gmail.com"},{"email":"brian.yicn@gmail.com"}]', related_to: 'Nicole Simulcik', column: 'in_progress', created_by: 'victoriafeliciapatindol@gmail.com', created_at: '2026-03-16' },
    ];

    let inserted = 0;
    for (const t of REAL_TASKS) {
      const res = await p.query(
        `INSERT INTO tasks (id, company_id, title, description, status, priority, assigned_to,
          assignees, related_to, board_id, "column", created_by, data,
          created_at, updated_at)
         VALUES ($1, 'loc_mmdvp1h5_e8i9eb', $2, $3, 'pending', 'medium', $4,
           $5::jsonb, $6, 'tb_cs_main', $7, $8,
           '{"tags":[],"source":"csv_import"}'::jsonb,
           $9::timestamp, $9::timestamp)
         ON CONFLICT (id) DO NOTHING`,
        [t.id, t.title, t.description, t.assigned_to,
         t.assignees, t.related_to, t.column, t.created_by, t.created_at]
      );

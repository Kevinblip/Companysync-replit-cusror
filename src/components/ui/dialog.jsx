  ...
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ...
      className={cn(
        ...
        // Mobile: full screen
        "left-0 right-0 top-0 bottom-0 max-w-none rounded-none",
        // Desktop: centered modal
        "sm:left-[50%] sm:top-[50%] sm:right-auto sm:bottom-auto sm:translate-x-[-50%] sm:translate-y-[-50%] sm:max-w-lg sm:rounded-lg",
